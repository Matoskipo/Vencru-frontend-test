...
const RightSide = () => {
  ...
  return (
    <div className='w-full  lg:[1160px] pt-5 overflow-hidden pr-3 '>
        ...
        <div className='overflow-auto lg:overflow-hidden'>
            <div className='flex  w-[769px] h-[40px] bg-[white] border-2 border-borderC rounded-lg '>
                {PageLinks.map((link)=>{
                    ...
                    return(
                      <Link to={route} key={id} className={`${id !==PageLinks.length ? 'border-r-2 border-borderC' :''} flex justify-center items-center text-[14px] `}
        ...
        <div className='flex flex-col lg:flex-row justify-between mr-3 mt-5'>
            <h1 className='mb-2'>Billing History</h1>
             ...
             <img src={cloud} className="inline-block h-8 w-8 mr-2 " alt="Button image" />
              <p className='font-medium text-[14px] text-[#344054]'>Download all</p> 
            </button>
